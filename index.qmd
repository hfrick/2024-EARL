...
format:
  revealjs: 
    ...
    footer: <https://hfrick.github.io/2024-EARL>
...
## tidymodels for time-to-event data {visibility="hidden"}
...
- [Predictions](https://censored.tidymodels.org/#available-models-engines-and-prediction-types):  
  survival time, survival probability, hazard, and linear predictor
- [Metrics](https://yardstick.tidymodels.org/reference/index.html#dynamic-survival-metrics):  
  [Max Kuhn's talk](https://topepo.github.io/2024-posit-conf) at posit::conf 2024, [various articles](https://www.tidymodels.org/learn/#category=survival%20analysis) on [tidymodels.org](https://www.tidymodels.org/)
  <!-- concordance index, Brier score, integrated Brier score, AUC ROC -->
